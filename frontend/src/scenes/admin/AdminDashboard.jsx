            ...
            {adminModules.map((module) => (
              <Grid item xs={12} sm={6} md={4} lg={4} key={module.id}>
                <Card
                  sx={{
                    height: "100%",
                    minHeight: isSimplifiedWidget ? "120px" : isTablet ? "280px" : "320px",
                    transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
                    overflow: "hidden",
                    ...
                    border: "1px solid rgba(0,0,0,0.05)",
                    "&:hover": {
                      transform: isSimplifiedWidget ? "translateY(-2px)" : "translateY(-4px)",
                      boxShadow:
                        "0 8px 25px rgba(0,0,0,0.12), 0 4px 12px rgba(0,0,0,0.08)",
                    },
                  }}
                  ...
                  >
                    <Box
                      ...
                      sx={{
                        ...
                        background: `linear-gradient(135deg, ${module.color}15 0%, ${module.color}08 100%)`,
                        borderBottom: isSimplifiedWidget ? "none" : `2px solid ${module.color}30`,
                        display: "flex",
                        flexDirection: isSimplifiedWidget ? "column" : "row",
                        alignItems: "center",
                        justifyContent: "center",
                        position: "relative",
                        padding: isSimplifiedWidget ? "12px" : isTablet ? "20px" : "24px",
                        transition: "all 0.3s ease-in-out",
                        "&:hover": {
                          background: `linear-gradient(135deg, ${module.color}20 0%, ${module.color}12 100%)`,
                          borderBottom: isSimplifiedWidget ? "none" : `2px solid ${module.color}40`,
                        },
                      }}
                    >
                      <Box
                      ...
                      >
                        {React.cloneElement(module.icon, {
                          sx: {
                            fontSize: isSimplifiedWidget ? 24 : isTablet ? 48 : 60,
                            color: module.color,
                            filter: "drop-shadow(0 1px 2px rgba(0,0,0,0.1))",
                          },
                        })}
