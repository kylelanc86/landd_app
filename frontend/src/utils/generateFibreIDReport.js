...
pdfMake.fonts = {
  ...
  console.log('reportIssueDate:', reportIssueDate, 'type:', typeof reportIssueDate);
  console.log('sampleItems:', sampleItems, 'type:', typeof sampleItems, 'length:', sampleItems?.length);
  if (sampleItems && sampleItems.length > 0) {
    console.log('sampleItems[0].analysisData?.analysedAt:', sampleItems[0].analysisData?.analysedAt, 'type:', typeof sampleItems[0].analysisData?.analysedAt);
  }
