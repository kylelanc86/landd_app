...
const CustomDataFieldGroupSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    required: true,
    enum: ['asbestos_removalist', 'location_description', 'materials_description', 'materials_description_non_acm', 'room_area', 'legislation', 'project_status', 'recommendation', 'glossary', 'fibre_id_samples_description'],
    index: true
  },
  fields: [{
    text: {
