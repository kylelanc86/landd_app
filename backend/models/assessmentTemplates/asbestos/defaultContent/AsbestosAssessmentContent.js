// Default content for Asbestos Assessment Report Templates
const asbestosAssessmentDefaultContent = {
  // Front Cover Content
  frontCoverTitle: "ASBESTOS MATERIAL ASSESSMENT REPORT",
  frontCoverSubtitle: "Assessment Report",
  
  // Version Control Page Content
  versionControlTitle: "ASBESTOS MATERIAL ASSESSMENT REPORT",
  ...
  surveyFindingsContentNoSamples: "No physical samples were collected during this assessment. The assessment was conducted as a visual inspection only, with no materials sent for laboratory analysis.",
...
module.exports = asbestosAssessmentDefaultContent; 