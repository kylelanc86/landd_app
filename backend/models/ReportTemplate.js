...
const reportTemplateSchema = new mongoose.Schema(
  {
    ...
    standardSections: {
      ...
      assessmentMethodologyLeadPaintContent: String,
      assessmentMethodologyLeadDustContent: String,
      assessmentMethodologyLeadSoilContent: String,
      assessmentFindingsLeadPaintContent: String,
      assessmentFindingsLeadDustContent: String,
      assessmentFindingsLeadSoilContent: String,
      samplingResultsTitle: String,
      samplingResultsContent: String,
      assessmentCriteriaLeadPaintContent: String,
      assessmentCriteriaLeadDustContent: String,
      assessmentCriteriaLeadSoilContent: String,
      riskAssessmentLeadPaintContent: String,
      riskAssessmentLeadDustContent: String,
      riskAssessmentLeadSoilContent: String,
